	...
	$('.imageUploadMultiple').each(function (index, item)
	{
		...
		flow.on('fileSuccess', function(file,message){
			...
			$innerGroup.append('<div class="col-xs-6 col-md-3 imageThumbnail"><div class="thumbnail">' +
				'<img style="width: 300px; height: 300px;" data-value="' + result.value + '" src="' + result.url + '" />' +
				'<a href="#" class="imageRemove">Удалить</a></div>' +
				''+
				'<label for="imgtitle[]">Title</label>'+
				'<input class="form-control" name="imgtitle[]" type="text" value="">'+
				''+
				'<label for="imgalt[]">Alt</label>'+
				'<input class="form-control" name="imgalt[]" type="text" value="">'+
				''+
				'<label for="imgdesc[]">Описание</label>'+
				'<input class="form-control" name="imgdesc[]" type="text" value="">'+
				''+
				'</div>'+
				''
